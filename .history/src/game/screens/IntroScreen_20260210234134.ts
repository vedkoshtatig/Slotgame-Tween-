...
export class IntroScreen extends PIXI.Container {
  ...
  build() {
    ...
    lBtn.anchor.set(0.5);
    lBtn.position.set(
      this.app.screen.width / 2 - 415,
      this.app.screen.height / 2 - 95
    );
    lBtn.scale.set(0.5);
    ...
    playBtn.on("pointerout", () => {
      playBtn.texture = Assets.get("prePlayBtn_normal.png");
    });
