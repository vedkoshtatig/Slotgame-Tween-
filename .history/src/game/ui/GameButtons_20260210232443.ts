  ...
  build() {
    ...
    this.autoSpinBtn.on("pointerdown", () => {
      if (this.autoSpinState === 0) {
        if(this.reelarea.isSpinning){this.autoSpinBtn.texture = Assets.get("menu_autospin_down.png");
    ...
    this.turboSpinBtn.on("pointerdown", ()=>{
      if(this.turboSpinState===0){
         this.turboSpinBtn.texture = Assets.get("menu_quickSpin_down.png")
         this.emit("turboSpinOn")
         this.turboSpinState=1;
      }else if(this.turboSpinState===1){
        this.turboSpinBtn.texture = Assets.get("menu_quickSpinOn_normal.png")
         this.emit("turboSpinOff")
         this.turboSpinState=0;
      }
